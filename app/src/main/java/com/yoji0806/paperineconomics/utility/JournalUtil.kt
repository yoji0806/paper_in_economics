...
class JournalUtil {
    ...
    fun getJournalLogo(journal: String): Int {
        return when (journal) {
            journalAER -> R.drawable.ic_aer_logo_circle
            journalEconometrica -> R.drawable.ic_econometrica_logo_circle
            else -> R.drawable.ic_unknow_rectangle
        }
    }



    fun jefCodeToClassification(code: String): String {
        return when(code) {
